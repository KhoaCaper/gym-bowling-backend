-- =============================================
-- Gym Bowling Database Setup Script (Complete)
...
-- Create services table (linked to centers and service_types)
...
-- Sample Time Frames (center operating hours)
...
-- Center B: 5AM-11PM weekdays, 7AM-9PM weekends  
...
SELECT 'ROLES:' as Category, name as Name, description as Description FROM roles
UNION ALL
SELECT 'SERVICE_TYPES:', name, description FROM service_types
UNION ALL  
SELECT 'CENTERS:', name, address FROM centers
ORDER BY Category, Name;

-- Show center capabilities
SELECT 
    c.name as Center,
...
PRINT 'Next: Update Firebase config and test APIs!';
